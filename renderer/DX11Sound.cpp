...
namespace Transmission {
	DX11Sound::DX11Sound( HWND hwnd ) {
		m_DirectSound = nullptr;
		m_primaryBuffer = nullptr;
		this->secondaryBuffers = new std::vector<IDirectSoundBuffer8*>();
	...
	DX11Sound::~DX11Sound() {
		...
		delete this->secondaryBuffers;
	}

	bool DX11Sound::InitializeDirectSound( HWND hwnd ) {
		HRESULT result;
	...
	void DX11Sound::ShutdownDirectSound() {
		// Release all secondary buffers
		for( size_t i = 0; i < this->secondaryBuffers->size(); ++i ) {
			this->secondaryBuffers->at(i)->Release();
			this->secondaryBuffers->at(i) = nullptr;
		}
	...
	int DX11Sound::LoadWaveFile( char* filename ) {
		int error;
		FILE* filePtr;
		...
		this->secondaryBuffers->push_back( secondaryBuffer );
